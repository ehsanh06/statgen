...
handlebars.registerPartial('nav', fs.readFileSync(config().paths.includes + 'nav.hbs', 'utf8'));
handlebars.registerPartial('header', fs.readFileSync(config().paths.includes + 'header.hbs', 'utf8'));
handlebars.registerPartial('footer', fs.readFileSync(config().paths.includes + 'footer.hbs', 'utf8'));
handlebars.registerPartial('recent', fs.readFileSync(config().paths.includes + 'recent.hbs', 'utf8'));
...
function readMarkdownFiles() {
    ...
    if (utils.directoryExists(config().paths.posts)) {
    ...
    if (utils.directoryExists(config().paths.pages)) {
