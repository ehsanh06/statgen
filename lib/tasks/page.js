...
function page() {
    ...
    if (argv.title || argv.t) {
        ...
        var slug = (argv.slug || argv.s) ? utils.hyphenateString(argv.slug || argv.s) : utils.hyphenateString(title.toString());

        // Filename has the value of the file path of the page in question
        var filename = utils.srcDir.pages + slug + '.md';
        ...
        fs.access(filename, fs.F_OK, function (err) {
            ...
            mkdirp(utils.srcDir.pages, function (err) {
